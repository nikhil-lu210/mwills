...
<head>
    ...
    <style>
        body { font-family: var(--font-body); font-size: 16px; color: var(--color-navy); }
        ...
        <div class="max-w-content mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <div class="hidden md:flex items-center gap-8">
                    <a href="{{ route('home') }}" class="text-sm font-semibold text-navy hover:text-gold transition-colors">Home</a>
                    <div class="relative group">
                        <button type="button" class="text-sm font-semibold text-navy hover:text-gold transition-colors flex items-center">
                            What We Do
                        ...
                        <div class="absolute left-0 mt-2 w-72 rounded-sm shadow-lg bg-white ring-1 ring-black/5 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 border-t-2 border-gold">
                            <div class="py-2">
                                <a href="{{ route('services.strategy') }}" class="block px-4 py-3 text-sm text-navy hover:bg-offwhite hover:text-gold transition-colors">Strategy & Market Intelligence</a>
                                <a href="{{ route('services.bd') }}" class="block px-4 py-3 text-sm text-navy hover:bg-offwhite hover:text-gold transition-colors">Business Development & Growth</a>
                                <a href="{{ route('services.talent') }}" class="block px-4 py-3 text-sm text-navy hover:bg-offwhite hover:text-gold transition-colors">Talent & People Solutions</a>
                                <a href="{{ route('services.content') }}" class="block px-4 py-3 text-sm text-navy hover:bg-offwhite hover:text-gold transition-colors">Content & Communications</a>
                            </div>
                        </div>
                    </div>
                ...
                <details class="md:hidden group/menu">
                    <summary class="list-none p-2 cursor-pointer text-navy hover:text-gold focus:outline-none [&::-webkit-details-marker]:hidden" aria-label="Toggle menu">
                        ...
                        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3 max-w-content mx-auto">
                            ...
                            <div class="px-3 py-2 text-base font-semibold text-navy">
                                ...
                                <div class="pl-4 mt-2 space-y-2 border-l-2 border-gold">
                                    <a href="{{ route('services.strategy') }}" class="block text-sm text-navy hover:text-gold">Strategy & Market Intelligence</a>
                                    <a href="{{ route('services.bd') }}" class="block text-sm text-navy hover:text-gold">Business Development & Growth</a>
                                    <a href="{{ route('services.talent') }}" class="block text-sm text-navy hover:text-gold">Talent & People Solutions</a>
                                    <a href="{{ route('services.content') }}" class="block text-sm text-navy hover:text-gold">Content & Communications</a>
                                </div>
                            </div>
                            <a href="{{ route('intelligence') }}" class="block px-3 py-2 text-base font-semibold text-navy hover:text-gold">Intelligence</a>
                            <a href="{{ route('about') }}" class="block px-3 py-2 text-base font-semibold text-navy hover:text-gold">About</a>
                            <a href="{{ route('contact') }}" class="block w-full text-left px-3 py-3 mt-4 bg-gold text-white font-semibold text-base rounded-sm">Book a Consultation</a>
                        </div>
                    </div>
                </details>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-slate">
                        <li><a href="{{ route('services.strategy') }}" class="hover:text-white transition-colors">Strategy & Market Intelligence</a></li>
                        <li><a href="{{ route('services.bd') }}" class="hover:text-white transition-colors">Business Development & Growth</a></li>
                        <li><a href="{{ route('services.talent') }}" class="hover:text-white transition-colors">Talent & People Solutions</a></li>
                        <li><a href="{{ route('services.content') }}" class="hover:text-white transition-colors">Content & Communications</a></li>
                    </ul>
                </div>
                <div>
                    <h4 class="font-bold text-gold text-sm uppercase tracking-wider mb-4">Company</h4>
                    <ul class="space-y-2 text-sm text-slate">
                        <li><a href="{{ route('intelligence') }}" class="hover:text-white transition-colors">Intelligence Desk</a></li>
                        <li><a href="{{ route('about') }}" class="hover:text-white transition-colors">About the Practice</a></li>
                        <li><a href="{{ route('contact') }}" class="hover:text-white transition-colors">Contact</a></li>
                    </ul>
                </div>
            </div>
            <div class="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate">

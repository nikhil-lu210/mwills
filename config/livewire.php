...
return [
    ...
    */
    ...
    |---------------------------------------------------------------------------
    |
    | This value is used to specify where Livewire component class files are
    ...
    */
    ...
    |
    | Rich post bodies with embedded base64 images exceed 1MB easily; the editor
    | uploads images to /storage instead of inline data URLs—keep a margin here.
    |
    */

    'payload' => [
        'max_size' => 15 * 1024 * 1024, // 15MB (default was 1MB)
